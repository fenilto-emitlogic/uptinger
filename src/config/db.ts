...
const monitorTypeSeed: Array<{ key: string; label: string; description: string; icon: string; category: string; sort_order: number }> = [
    ...
    { key: 'vps', label: 'VPS Performance', description: 'CPU, RAM, disk, network and Nginx stats pushed by a lightweight agent installed on your server', icon: 'cpu', category: 'Passive', sort_order: 4 },
